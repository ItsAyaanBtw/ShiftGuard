...
export const DEMO_SCENARIOS = [
  ...
  {
    id: 'organizer',
    name: 'Dr. Amara Chen, 44',
    role: 'Workforce coordinator at National Nurses United, Texas region',
    industry: 'Healthcare labor · Nurses union',
    industryKey: 'healthcare_union',
    stubImage: '/demo/paystub-union-member.svg',
    audience: 'b2b',
    organizer: {
      orgName: 'National Nurses United',
      orgType: 'Nurses union',
      city: 'Houston, TX',
      memberCount: 312,
      flaggedStubs: 47,
      topEmployer: 'Hermann Memorial Health System',
      patternSummary:
        'Across 312 represented RNs at Hermann Memorial, 47 paystubs are missing the night-shift differential and weekend premium written into Article 9 of the 2025-2028 CBA.',
    },
    summary:
      'Your member Jasmine Okonkwo, an ICU nurse at Hermann Memorial, is missing two CBA-guaranteed premiums this period (night shift $4.50/hr and weekend $3.00/hr). Same pattern is showing up across 46 other nurses on this contract.',
    tagline: 'Cohort pattern: ~$760 per affected nurse in missed differentials',
    stateCode: 'TX',
    city: null,
    buildShifts: (base) => [
      makeShift(base, 0, '19:00', '07:30', 30, 0, false, { shiftType: 'night' }),
      makeShift(base, 1, '19:00', '07:30', 30, 0, false, { shiftType: 'night' }),
      makeShift(base, 2, '19:00', '07:30', 30, 0, false, { shiftType: 'night' }),
      makeShift(base, 5, '19:00', '07:30', 30, 0, false, { shiftType: 'night', isWeekend: true }),
      makeShift(base, 6, '19:00', '07:30', 30, 0, false, { shiftType: 'night', isWeekend: true }),
      makeShift(base, 7, '19:00', '07:30', 30, 0, false, { shiftType: 'night' }),
      makeShift(base, 8, '19:00', '07:30', 30, 0, false, { shiftType: 'night' }),
    ],
    paystub: (base) => ({
      employer_name: 'Hermann Memorial Health System',
      pay_period_start: fmtDate(base, 0),
      pay_period_end: fmtDate(base, 13),
      hours_paid: 72,
      overtime_hours_paid: 12,
      hourly_rate: 46.5,
      overtime_rate: 69.75,
      gross_pay: 4185.0,
      deductions: [
        { name: 'Federal Tax', amount: 502.20 },
        { name: 'Social Security', amount: 259.47 },
        { name: 'Medicare', amount: 60.68 },
        { name: 'NNU Dues', amount: 56.0 },
        { name: 'Medical (Union Plan)', amount: 114.0 },
        { name: '403(b) Retirement', amount: 167.40 },
      ],
      tips_reported: 0,
      net_pay: 3025.25,
    }),
    prefs: {
      ...
      filingStatus: 'single',
      organizerMode: true,
      organizerOrgName: 'National Nurses United',
      organizerOrgType: 'Nurses union',
      organizerCity: 'Houston, TX',
      organizerMemberCount: 312,
      organizerFlaggedStubs: 47,
      organizerTopEmployer: 'Hermann Memorial Health System',
...
function departmentFor(scenarioId) {
  switch (scenarioId) {
    ...
    case 'organizer': return 'Medical ICU, Tower 3'
    default:          return ''
  }
}
