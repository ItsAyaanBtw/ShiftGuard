    ...
    <div className="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden">
      ...
      >
        ...
        <div className="flex-1">
          <p className="text-sm font-medium text-white">Know your rights before taking action</p>
          <p className="text-xs text-slate-500 mt-0.5">Anti-retaliation protections under federal and {stateCode} law</p>
        </div>
        {open
      ...
      {open && (
        <div className="px-4 pb-4 space-y-3 border-t border-slate-800 pt-3">
          ...
          <p className="text-xs text-slate-600 pt-1">
            If you experience retaliation after filing a complaint, document everything and contact an employment attorney immediately.
          </p>
        </div>
      )}
    </div>
